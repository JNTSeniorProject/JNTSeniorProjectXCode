...
class DateCellTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let itemOne = [titleKey : "Start Date", dateKey : NSDate()] as [String : Any]
        let itemTwo = [titleKey : "Start Time", dateKey : NSDate()] as [String : Any]
        let itemThree = [titleKey : "End Time", dateKey : NSDate()] as [String : Any]
        let itemFour = [titleKey : "End Date", dateKey : NSDate()] as [String : Any]
        
        dataArray = [/*itemOne as Dictionary<String, AnyObject>,*/ itemOne as Dictionary<String, AnyObject>, itemTwo as Dictionary<String, AnyObject>, itemThree as Dictionary<String, AnyObject>, itemFour as Dictionary<String, AnyObject>]
